...
export const DEGREES: Degree[] = [
  // PRE-GRAD / TERCIARIO — ordered by importance
  {
    ...
    university: "Liceo Superior de Cultura Inglesa (Higher Institute of English Culture)",
  ...
  },
  {
    ...
    university: "Universidad Empresarial Siglo XXI (Siglo 21 Business University)",
  ...
  },
  {
    ...
    university: "Escuela Superior de Psicología Social (Higher School of Social Psychology)",
  ...
  // GRADO / BACHELOR — ordered by importance
  {
    ...
    university: "Universidad Nacional del Chaco Austral (National University of Chaco Austral)",
  ...
  },
  {
    ...
    university: "Universidad Nacional de la Matanza (National University of La Matanza)",
  ...
  },
  {
    ...
    university: "Universidad Nacional de Quilmes (National University of Quilmes)",
  ...
  },
  {
    ...
    university: "Universidad Nacional de Río Negro (National University of Río Negro)",
  ...
  },
  {
    ...
    university: "Universidad de Concepción del Uruguay (University of Concepción del Uruguay)",
  ...
  // ESPECIALIZACIÓN — ordered by importance
  {
    ...
    university: "Universidad Nacional de General San Martín (National University of San Martín)",
  ...
  },
  {
    ...
    university: "Universidad de Morón (University of Morón)",
  ...
  },
  {
    ...
    university: "Universidad de Buenos Aires (University of Buenos Aires)",
  ...
  },
  {
    ...
    university: "Universidad Europea del Atlántico (European University of the Atlantic)",
  ...
  },
  {
    ...
    university: "Universidad Internacional de La Rioja (International University of La Rioja)",
